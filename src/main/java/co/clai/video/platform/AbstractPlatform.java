...
import co.clai.video.util.AbstractCachedQueryConnection;
import co.clai.video.util.cache.Cache;
import co.clai.video.util.cache.ExpiringCache;
...
public abstract class AbstractPlatform extends AbstractCachedQueryConnection {
	...
	private static Map<String, Class<? extends AbstractPlatform>> loadAbstractPlatform() {
		...
		Reflections reflections = new Reflections("co.clai.video.platform");
