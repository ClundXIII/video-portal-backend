...
import co.clai.video.util.CookieManager;
...
public interface HttpTest {
	...
	default String httpRequestAsUser(String username, String password, String host, String url) {
		...
		try {
			loginUrl = new URL(host + "/profile.login?username=" + username + "&password=" + password + "");
